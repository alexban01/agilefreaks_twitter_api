...
ActiveRecord::Schema[8.1].define(version: 2026_08_16_213000) do
  create_table "comments", primary_key: "uuid", id: :string, force: :cascade do |t|
    t.string "content"
  ...
  add_foreign_key "comments", "tweets", primary_key: "uuid", on_delete: :cascade
